...
import (
	...
	"github.com/Ezkerrox/bsc/crypto/signify"
	"github.com/Ezkerrox/bsc/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/Ezkerrox/bsc/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/Ezkerrox/bsc/internal/version.gitDate="+env.Date)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/Ezkerrox/bsc/core/rawdb", "github.com/Ezkerrox/bsc/ethdb/leveldb"},
		{"github.com/Ezkerrox/bsc/core/rawdb", "github.com/Ezkerrox/bsc/ethdb/pebbledb"},
	}
