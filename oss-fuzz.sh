...
coverpkg="github.com/Ezkerrox/bsc/..."
...
repo=$GOPATH/src/github.com/Ezkerrox/bsc
compile_fuzzer github.com/Ezkerrox/bsc/accounts/abi \
  FuzzABI fuzzAbi \
  $repo/accounts/abi/abifuzzer_test.go

compile_fuzzer github.com/Ezkerrox/bsc/common/bitutil \
...
compile_fuzzer github.com/Ezkerrox/bsc/eth/protocols/snap \
...
compile_fuzzer github.com/Ezkerrox/bsc/tests/fuzzers/bn256 \
...
compile_fuzzer github.com/Ezkerrox/bsc/tests/fuzzers/txfetcher \
  Fuzz fuzzTxfetcher \
  $repo/tests/fuzzers/txfetcher/txfetcher_test.go

compile_fuzzer github.com/Ezkerrox/bsc/tests/fuzzers/bls12381 \
...
compile_fuzzer github.com/Ezkerrox/bsc/tests/fuzzers/secp256k1 \
  Fuzz fuzzSecp256k1\
  $repo/tests/fuzzers/secp256k1/secp_test.go

compile_fuzzer github.com/Ezkerrox/bsc/eth/protocols/eth \
